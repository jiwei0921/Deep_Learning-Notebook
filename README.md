...
:triangular_flag_on_post:52 | **Notes** | [大模型的Prompt Tuning/Adaption](https://mp.weixin.qq.com/s/0AAMzPCgmsXGxfLlHy3F5g) & [LoRA](https://mp.weixin.qq.com/s/4wn4cDEkmXhOiwggLpLiRw) & [中文详解 Adapter-Tuning](https://blog.csdn.net/weixin_48185819/article/details/124408981) 
...
:triangular_flag_on_post:26 | **Analysis Tools** | [FiftyOne 分析数据集、评估模型、潜入层可视化、find ann mistakes](https://docs.voxel51.com)
